...
class MigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'laraccount:migration';
     ...
     * @var string
     */
    protected $description = 'Creates a migration following the Laraccount specifications.';
     ...
     * @var string
     */
    protected $migrationSuffix = 'laraccount_setup_tables';
    ...
    {
        $this->laravel->view->addNamespace('laraccount', __DIR__.'/../../views');
        $this->line('');
        $this->info("Laraccount Migration Creation.");
        $this->line('');
    ...
    protected function createMigration()
    {
        ...
        $output = $this->laravel->view
            ->make('laraccount::migration')
            ->with(['laraccount' => Config::get('laraccount')])
            ->render();
    ...
    {
        $tables = Collection::make(Config::get('laraccount.tables'))->sort();
    ...
    protected function getExistingMigrationsWarning(array $existingMigrations)
    {
        if (count($existingMigrations) > 1) {
            $base = "Laraccount migrations already exist.\nFollowing files were found: ";
        } else {
            $base = "Laraccount migration already exists.\nFollowing file was found: ";
        }
